...
int main() {
  ...
  uint32_t* N_list[32]   = {N1, N2, N3, N4, N5};
  uint32_t* e_list[32]   = {e1, e2, e3, e4, e5};
  uint32_t* M_list[32]   = {M1, M2, M3, M4, M5};
  uint32_t* R_N_list[32] = {R_N1, R_N2, R_N3, R_N4, R_N5};
  uint32_t* R2_N_list[32] = {R2_N1, R2_N2, R2_N3, R2_N4, R2_N5};
  uint32_t* res_list[32] = {res1, res2, res3, res4, res5};
